...
export async function startGatewayServer(
  ...
  let rpcContext: { context: GatewayRequestContext; extraHandlers: GatewayRequestHandlers } | null = null;
  const getRpcContext = () => rpcContext;
  ...
  rpcContext = { context: gatewayContext, extraHandlers: allExtraHandlers };
  ...
  attachGatewayWsHandlers({
    ...
    logHealth,
    logWsControl,
    extraHandlers: allExtraHandlers,
    broadcast,
