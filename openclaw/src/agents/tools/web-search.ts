...
async function runWebSearch(params: {
  ...
  if (params.search_lang) {
    // Fix common AI mistake: Brave requires zh-hans/zh-hant, not zh
    const lang = params.search_lang.toLowerCase() === "zh" ? "zh-hans" : params.search_lang;
    url.searchParams.set("search_lang", lang);
  }
  if (params.ui_lang) {
    // Fix common AI mistake: Brave requires zh-CN, not zh
    const lang = params.ui_lang.toLowerCase() === "zh" ? "zh-CN" : params.ui_lang;
